# Generated by Powerlevel10k configuration wizard on 2022-05-16 at 04:32 IST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND='#3c3836'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='#3c3836'  # grey foreground
      ...
      local       meta='#3c3836'  # grey foreground
      local      clean='#3c3836'  # grey foreground
      local   modified='#3c3836'  # grey foreground
      local  untracked='#3c3836'  # grey foreground
      local conflicted='#3c3836'  # grey foreground
    fi
